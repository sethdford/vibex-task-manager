 ...
 */
export async function directBedrockCall(params: DirectBedrockParams): Promise<BedrockResponse> {
 ...
 */
export async function directGenerateObject(params: DirectGenerateObjectParams): Promise<ObjectResponse> {
...
function getFieldType(field: z.ZodSchema): string {
    ...
    switch (def.typeName) {
        ...
        case 'ZodArray':
            const innerType = (field as any)._def.type ? getFieldType((field as any)._def.type) : 'any';
