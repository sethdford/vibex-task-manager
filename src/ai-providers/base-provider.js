...
export class BaseAIProvider {
    ...
    async generateObject(params) {
        try {
            ...
            log('debug', `Generating ${this.name} object ('${params.objectName}') with model: ${params.modelId}`);
            const client = this.getClient(params);
            ...
            log('debug', `${this.name} generateObject completed successfully for model: ${params.modelId}`);
            return {
