 ...
 */
async function updateSubtaskById(tasksPath, subtaskId, prompt, useResearch = false, context = {}, outputFormat = context.mcpLog ? 'json' : 'text') {
    ...
    try {
        ...
        if (outputFormat === 'text') {
            ...
            console.log(boxen(chalk.white.bold(`Updating Subtask #${subtaskId}`), {
                padding: 1,
                borderColor: 'blue',
                borderStyle: 'round',
            ...
            loadingIndicator = startLoadingIndicator(useResearch
...
4. Ensure the generated text is concise yet complete for the update based on the user request. Avoid conversational fillers or explanations about what you are doing (e.g., do not start with "Okay, here's the update...").`;
        ...
        if (generatedContentString && generatedContentString.trim()) {
            ...
            report('warn', 'AI response was empty or whitespace after trimming. Original details remain unchanged.');
        ...
        if (outputFormat === 'text') {
            ...
            console.log(boxen(chalk.green(`Successfully updated subtask #${subtaskId}`) +
                '\n\n' +
                ...
                '\n' +
                chalk.white(newlyAddedSnippet), { padding: 1, borderColor: 'green', borderStyle: 'round' }));
        }
        ...
        if (outputFormat === 'text') {
            ...
            if (error.message?.includes('ANTHROPIC_API_KEY')) {
                ...
                console.log('  2. Or run without the research flag: vibex-task-manager update-subtask --id=<id> --prompt="..."');
            }
