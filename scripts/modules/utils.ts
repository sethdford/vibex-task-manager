 ...
 */
async function getTaskManager(): Promise<any> {
 ...
 */
function taskExists(tasks: Task[], taskId: string | number): boolean {
...
): { task: Task | Subtask | null; originalSubtaskCount: number | null } {
	if (!taskId || !tasks || !Array.isArray(tasks)) {
